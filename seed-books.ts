...
const mockBooksRaw = [
    {
        ...
        price: 35,
        saleType: "direct",
        coverImage: "/articles/decoloniser-le-futur.png",
        authorName: "sename",
        tags: ["featured", "essai"],
        stock: 100
    },
    {
        ...
        price: 25,
        saleType: "direct",
        coverImage: "/articles/le-centre-des-flammes.png",
        authorName: "sename",
        tags: ["poésie"],
        stock: 100,
        staticReviews: [
    ...
    },
    {
        ...
        price: 30,
        saleType: "direct",
        coverImage: "/articles/girations.png",
        authorName: "sename",
        tags: ["poésie"],
        stock: 100
    },
    {
        ...
        coverImage: "/articles/principe-cosmo-architecture.jpeg",
        authorName: "sename",
        tags: ["architecture"],
        stock: 100
    },
    {
        ...
        price: 40,
        saleType: "crowdfunding",
        coverImage: "/articles/comprendre-architecture-afrique-noire.jpeg",
        authorName: "sename",
        tags: ["architecture"],
        stock: 100
    },
    {
        ...
        price: 35,
        saleType: "crowdfunding",
        coverImage: "/articles/esthetique-du-feminin.jpeg",
        authorName: "sename",
        tags: ["arts"],
        stock: 100
    },
    {
        ...
        price: 20,
        saleType: "crowdfunding",
        coverImage: "/articles/rencontres.jpeg",
        authorName: "sename",
        tags: ["littérature"],
        stock: 100
    },
    {
        ...
        price: 35,
        saleType: "preorder",
        coverImage: "/articles/ce-qui-demeure.png",
        authorName: "sename",
        tags: ["essai"],
        stock: 100
    },
    {
        ...
        price: 35,
        saleType: "preorder",
        coverImage: "/articles/a-lendroit.png",
        authorName: "sename",
        tags: ["essai"],
        stock: 100
    }
