...
export const mockBooks = [
  {
    ...
    price: 35,
    saleType: "direct",
    coverImage: "/article/decoloniser-le-futur.png",
    galleryImages: [],
    authorName: "sename",
    tags: ["featured", "essai"],
    coverVariant: "light",
  ...
  },
  {
    ...
    price: 25,
    saleType: "direct",
    coverImage: "/article/le-centre-des-flammes.png",
    galleryImages: [],
    authorName: "sename",
    tags: ["poésie"],
    coverVariant: "light"
  },
  {
    ...
    price: 30,
    saleType: "direct",
    coverImage: "/article/girations.png",
    galleryImages: [],
    authorName: "sename",
    tags: ["poésie"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 15000,
    fundingRaised: 8500,
    coverImage: "/article/principe-cosmo-architecture.jpeg",
    galleryImages: [],
    authorName: "sename",
    tags: ["architecture"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 12000,
    fundingRaised: 4200,
    coverImage: "/article/comprendre-architecture-afrique-noire.jpeg",
    galleryImages: [],
    authorName: "sename",
    tags: ["architecture"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 10000,
    fundingRaised: 6000,
    coverImage: "/article/esthetique-du-feminin.jpeg",
    galleryImages: [],
    authorName: "sename",
    tags: ["arts"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 5000,
    fundingRaised: 1200,
    coverImage: "/article/rencontres.jpeg",
    galleryImages: [],
    authorName: "sename",
    tags: ["littérature"],
    coverVariant: "light"
  },
  {
    ...
    price: 35,
    saleType: "preorder",
    coverImage: "/article/ce-qui-demeure.png",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light",
  ...
  },
  {
    ...
    price: 35,
    saleType: "direct",
    coverImage: "/article/a-lendroit.png",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light",
  ...
  },
  {
    ...
    price: 35,
    saleType: "preorder",
    coverImage: "/article/etatdulieu.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light"
