...
export const mockBooks = [
  {
    ...
    price: 35,
    saleType: "direct",
    coverImage: "/article/decoloniser-le-futur-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["featured", "essai"],
    coverVariant: "light",
  ...
  },
  {
    ...
    price: 25,
    saleType: "direct",
    coverImage: "/article/le-centre-des-flammes-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["poésie"],
    coverVariant: "light"
  },
  {
    ...
    price: 30,
    saleType: "direct",
    coverImage: "/article/girations-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["poésie"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 15000,
    fundingRaised: 0,
    coverImage: "/article/principe-cosmo-architecture-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["architecture"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 12000,
    fundingRaised: 0,
    coverImage: "/article/comprendre-architecture-afrique-noire-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["architecture"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 10000,
    fundingRaised: 0,
    coverImage: "/article/esthetique-du-feminin-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["arts"],
    coverVariant: "light"
  },
  {
    ...
    fundingGoal: 5000,
    fundingRaised: 0,
    coverImage: "/article/rencontres-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["littérature"],
    coverVariant: "light"
  },
  {
    ...
    subtitle: "Linéaments d'une refondation du politique",
    slug: "ce-qui-demeure",
    ...
    price: 35,
    saleType: "preorder",
    coverImage: "/article/lineaments.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light",
  ...
  },
  {
    ...
    price: 35,
    saleType: "preorder",
    coverImage: "/article/a-lendroit-new.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light",
  ...
  {
    _id: "653e8f1b9a1d4b001a2b3c58",
    title: "Hubcity",
    subtitle: "L'utopie concrétisée d'un néovernaculaire numérique",
    slug: "hubcity",
    description: "Manifeste pour la ville du futur.",
    price: 35,
    saleType: "crowdfunding",
    fundingGoal: 10000,
    fundingRaised: 0,
    coverImage: "/article/hubcity.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["architecture"],
    coverVariant: "light"
  ...
  {
    _id: "653e8f1b9a1d4b001a2b3c59",
    title: "Réflexions stratégiques sur la démographie africaine",
    subtitle: "Essai",
    slug: "reflexions-strategiques",
    description: "Analyses de la démographie africaine.",
    price: 30,
    saleType: "crowdfunding",
    fundingGoal: 15000,
    fundingRaised: 0,
    coverImage: "/article/reflexions-strategiques.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light"
  ...
  {
    _id: "653e8f1b9a1d4b001a2b3c5a",
    title: "Mauvaises fortunes et bon coeur",
    subtitle: "Roman",
    slug: "mauvaises-fortunes",
    description: "Récit captivant.",
    price: 25,
    saleType: "crowdfunding",
    fundingGoal: 5000,
    fundingRaised: 0,
    coverImage: "/article/mauvaises-fortunes.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["littérature"],
    coverVariant: "light"
  ...
  {
    _id: "653e8f1b9a1d4b001a2b3c5b",
    title: "Noir au cœur des lumières",
    subtitle: "Essai",
    slug: "noir-lumieres",
    description: "Réflexion sur les lumières.",
    price: 30,
    saleType: "crowdfunding",
    fundingGoal: 8000,
    fundingRaised: 0,
    coverImage: "/article/noir-lumieres.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["essai"],
    coverVariant: "light"
  ...
  {
    _id: "653e8f1b9a1d4b001a2b3c5c",
    title: "Dialogue sous la tente",
    subtitle: "Théâtre",
    slug: "dialogue-sous-la-tente",
    description: "Création théâtrale.",
    price: 20,
    saleType: "crowdfunding",
    fundingGoal: 4000,
    fundingRaised: 0,
    coverImage: "/article/theatre.jpg",
    galleryImages: [],
    authorName: "sename",
    tags: ["spectacle"],
    coverVariant: "light"
