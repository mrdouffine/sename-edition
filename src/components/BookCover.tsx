    ...
    return (
        <div className={`relative flex flex-col justify-between overflow-hidden ${className}`} style={{ backgroundColor: bgColor, aspectRatio: "3 / 4", width: "100%", position: "relative" }}>
            {imageFile ? (
                ...
                <div style={{ padding: "12% 6%", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", backgroundColor: bgColor }}>
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 px-1">
                        <h3 style={{
                            fontSize: title.length > 30 ? "clamp(1.1rem, 2.2vw, 1.5rem)" :
                                title.length > 20 ? "clamp(1.4rem, 2.6vw, 2rem)" :
